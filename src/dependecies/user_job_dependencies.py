...
def get_user_job_service(
        user_job_repository: UserJobRepository = Depends(get_user_job_repository),
        user_app_repository: UserAppRepository = Depends(get_user_repository),
):
